    ...
    <Link href={`/projects/${project.node.slug}`}>
      ...
      >
        ...
        >
          ...
          <button className="inline-flex items-center justify-center bg-fprimary px-4 py-2 text-lg font-bold text-fsecondary transition-colors duration-300 hover:bg-fsecondary/75 hover:text-fprimary text-center">
